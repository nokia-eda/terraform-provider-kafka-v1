...
package datasource_cluster_producer_list
...
func ClusterProducerListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ClusterProducerListModel struct {
