...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-kafka/internal/eda/utils"
...
var _ provider.Provider = (*kafkaProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &kafkaProvider{version: ver}
	}
}
...
func (p *kafkaProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *kafkaProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewClusterProducerDataSource,
		NewClusterProducerListDataSource,
		NewProducerDataSource,
		NewProducerListDataSource,
