---
page_title: "kafka-v1 Provider"
---

# kafka-v1 Provider

This provider is used to interact with the resources provided by the **kafka-v1** application of the [Nokia EDA](https://docs.eda.dev) platform.
