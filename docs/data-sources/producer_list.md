...
page_title: "kafka-v1_producer_list Data Source - kafka-v1"
subcategory: ""
description: |-
  
---

# kafka-v1_producer_list (Data Source)
...
- `spec` (Attributes) spec defines the desired state of Producer (see [below for nested schema](#nestedatt--items--spec))
...
- `status` (Attributes) status defines the observed state of Producer (see [below for nested schema](#nestedatt--items--status))
